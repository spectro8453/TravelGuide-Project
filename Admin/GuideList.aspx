<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="GuideList.aspx.cs" Inherits="Admin_Default" %>
            ...
            <td class="auto-style2">
                <asp:GridView ID="ddlDetails" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" OnRowCommand="ddlDetails_RowCommand" OnSelectedIndexChanged="ddlDetails_SelectedIndexChanged">
                    <Columns>
                        ...
                        <asp:BoundField DataField="guide_gender" HeaderText="Gender" />
                        <asp:BoundField DataField="district_name" HeaderText="District" />
                        <asp:BoundField DataField="place_name" HeaderText="Place" />
                        <asp:BoundField DataField="guide_contact" HeaderText="Contact" />
                        <asp:BoundField DataField="guide_email" HeaderText="E-mail" />
                        <asp:BoundField DataField="guide_password" HeaderText="Password" />
                        <asp:BoundField DataField="guide_pincode" HeaderText="Pincode" />
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:LinkButton ID="del" runat="server" CommandArgument='<%# Eval("guide_id") %>' CausesValidation="False" CommandName="del">Delete</asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
