...
public partial class Guest_Default : System.Web.UI.Page
{
    ...
    {
        string insQry = "insert into tbl_guideregistration(guide_gender,place_id,guide_contact,guide_email,guide_password,guide_pincode,guide_name)values('" + gender.SelectedValue + "','" + place.SelectedValue + "','" + contact.Text + "','" + email.Text + "','" + psswd.Text + "','" + pincode.Text + "','" + name.Text + "')";
