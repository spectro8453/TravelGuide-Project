...
public partial class Admin_Default : System.Web.UI.Page
{
    ...
    {
        string selQry = "select * from tbl_guideregistration n inner join tbl_place p on p.place_id=n.place_id inner join tbl_district d on d.district_id=p.district_id";
    ...
    protected void ddlDetails_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "del")
        {
            ...
            string delQry = "delete from tbl_guideregistration where guide_id='" + delID + "'";
