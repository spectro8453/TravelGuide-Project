<%@ Page Title="" Language="C#" MasterPageFile="~/User/PackageBooking/Purchasemaster.master" AutoEventWireup="true" CodeFile="PhotoList.aspx.cs" Inherits="User_PurchasePhoto_PhotoList" %>
        ...
        <tr>
            ...
            <td>
                <table class="auto-style9">
                    <tr>
                        <td class="auto-style11">Select Type</td>
                        <td>
                        ...
                        <table class="auto-style1">
                            <tr>
                                <td class="auto-style4" colspan="2">
                                    <asp:LinkButton ID="LinkButton1" runat="server" CommandName="view" CommandArgument='<%#Eval("package_image") %>' ToolTip="Click herer to view image">  <img src="../../Assests/PackageImage/<%#Eval("package_image") %>" width="125" height="125" /></asp:LinkButton>  
                            ...
                            <tr>
                                <td class="auto-style12">PackageName</td>
                                <td>
                                    <asp:Label ID="Label1" runat="server" style="font-size: medium" Text='<%# Eval("package_name") %>'></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td class="auto-style12">Rate</td>
                                <td class="auto-style6">
                                    <asp:Label ID="Label2" runat="server" Text='<%# Eval("package_rate") %>'></asp:Label>
                                </td>
                            </tr>
                             <tr>
                                <td class="auto-style12">No of Days</td>
                                <td class="auto-style6">
                                    <asp:Label ID="Label12" runat="server" Text='<%# Eval("package_noofdays") %>'></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td class="auto-style12">Details</td>
                                <td class="auto-style6">
                                    <asp:Label ID="Label3" runat="server" Text='<%# Eval("package_details") %>'></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td class="auto-style12">Type</td>
                                <td class="auto-style6">
                                    <asp:Label ID="Label4" runat="server" Text='<%# Eval("packagetype_name") %>'></asp:Label>
                                </td>
                            </tr>
                           
                            <tr>
                                <td class="auto-style12">
                                    <asp:LinkButton ID="LinkButton3" runat="server" CommandArgument='<%# Eval("package_id") %>' CommandName="com" >Comment</asp:LinkButton>
                                </td>
                                <td class="auto-style6">
                                    <asp:Button ID="Button1" runat="server" CommandArgument='<%# Eval("package_id") %>' CommandName="cart" Text="ViewMore" />
                                </td>
                            </tr>
                            <tr>
                                                ...
                                                <table class="style1">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="auto-style16">
                                                            <asp:Label ID="Label11" runat="server" Text='<%# Eval("user_name") %>'></asp:Label>
                                                        </td>
