<%@ Page Title="" Language="C#" MasterPageFile="~/User/PackageBooking/Purchasemaster.master" AutoEventWireup="true" CodeFile="NewBooking.aspx.cs" Inherits="User_PurchasePhoto_Default" %>
                        ...
                        <table class="auto-style1">
                            ...
                            <tr>
                                <td class="auto-style12">
                                    &nbsp;</td>
                                <td class="auto-style6">
                                    <asp:Button ID="Button1" runat="server" CommandArgument='<%# Eval("booking_id") %>' CommandName="del" Text="Delete" />
                                </td>
                            </tr>
                            <tr>
